...
身体健康不是单点指标，而是运动、睡眠、呼吸、疾病风险、训练选择和长期功能状态的综合结果。

| 文档 | 简介 |
|------|------|
| [《超越百岁》](./o/outlive.md) | 彼得·阿提亚关于运动、营养、睡眠与医学 3.0 的健康长寿框架 |
| [《无限可能的身体》](./b/book-infinite-body.md) | 从健康产品化批判和五组生活节律出发，理解怎样用习惯而非消费身份建立适应与恢复能力 |
...
免疫、炎症、过敏和慢性病常常互相交织，错误理解“免疫力”会导致无效补剂、过度清洁或延误诊疗。
...
香草和香料决定了很多食物的辨识度，理解它们能提升选购、烹饪和风味判断能力。
...
威士忌价格和风味常被营销放大，理解桶型、年份和缺陷能避免被品牌叙事牵着走。
...
幸福不是单一情绪，而是意义、关系、投入、成就和复原力共同构成的长期状态。
...
内在秩序会影响睡眠、关系、判断和抗压能力，是很多外部问题能否被处理好的底层条件。
...
情绪和欲望会直接驱动选择，理解它们能减少被冲动、回避和上瘾模式牵着走。
...
人格、依恋和创伤模式会影响关系、职业和自我评价，理解来源才更容易改变反复出现的问题。
...
人生问题会随年龄、责任和关系结构变化，提前理解阶段性任务能减少用旧答案处理新处境。
...
经典文学保存了人类反复遭遇的处境、欲望和困境，能训练对人生复杂性的感受力。
...
武侠小说用江湖、义气和选择放大人性问题，适合观察价值、代价和人格魅力。
...
习惯和专注力决定了长期目标能否落地，它们比短期热情更稳定地塑造结果。
...
职业能力决定个人在复杂系统中持续创造价值的方式，也影响自由度、收入和选择空间。
...
学习和判断能力是跨领域迁移的底层能力，决定一个人能否更新认知并避开常见误判。
...
财富不只是收入数字，还涉及杠杆、资产、时间自由、风险承受和生活方式选择。

| 文档 | 简介 |
|------|------|
| [中国低维护与无人值守自动化副业机会：筛选与验证](./a/automated-low-maintenance-income-china.md) | 区分“每天半小时”与“正常路径零人工”，复核数字商品、采购提醒、询盘监控和机会雷达；给出 499 元垂直数字商品店与全球远程创意岗位中文雷达的边界、收入数学和停止条件 |
| [中国近一月图片／视觉付费线索（CSV，2026-08-27 核验）](./i/image-generation-paid-leads-china-2026-08.csv) | 10 条带公开微信或电话的招聘与现金赛事线索；逐条标注发布日期、金额、付款确定性、资格限制、当前状态、来源 URL 和风险 |
| [摄影／直播器材租赁工作流包：20 个目标用户](./r/rental-workflow-target-users-china.md) | 筛选 20 家中国本地租赁商并补齐公开业务联络入口：8 家可直联、8 家走平台／认证社交账号、4 家需地图核验，同时提供优先级、个性化切口和联系前确认问题 |
| [“归还有据”摄影器材租赁工作流包商业计划书](./r/camera-rental-workflow-business-plan.md) | 把 20 家目标用户及联系方式、产品闭环、499 元定价、获客漏斗、三情景财务模型、低维护运营、14 天预售验证、合规边界和停止条件整合为可执行 BP |
